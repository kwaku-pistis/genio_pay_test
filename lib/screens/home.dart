            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  // border: Border(
                  //   left: BorderSide(color: AppColors.lightBlue, width: 1,),
                  //   top: BorderSide(color: AppColors.lightBlue, width: 1,),
                  //   right: BorderSide(color: AppColors.lightBlue, width: 1,),
                  // )
                ),
    ...
    return Align(
      ...
      child: SizedBox(
        child: SlidingUpPanel(
          controller: _pc,
          minHeight: Dimensions.getProportionateScreenHeight(316),
            ...
            items: imageList.map((i) {
              return Builder(
                builder: (BuildContext context) {
                  return Container(
                    width: Dimensions.getProportionateScreenWidth(296),
                    child: Image.asset(i),
                  );
                },
              );
